...
class BeritaHome extends StatelessWidget {
  ...
  Future<Map<String, dynamic>> getBerita() async {
    final response = await http.get(Uri.parse(
      "https://newsapi.org/v2/top-headlines?country=us&category=business&apiKey=be14be3a5ea949858c0c15edca7cd40d"));
            ...
            child: InkWell(
              onTap: () {
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => PageDetailBerita(data: data[index])));
              },
        child:Column(
